...
FAILED .mlflow.repo/tests/store/tracking/test_sqlalchemy_store.py::test_log_metric_concurrent_logging_succeeds - mlflow.exceptions.MlflowException: error creating metrics in batch for run_uuid "48241a0239c943cd8eda8af6efce93ea"
...
=========================================================================================== 7 failed, 352 passed, 9 skipped, 128 deselected, 10 warnings in 228.66s (0:03:48) ===========================================================================================
```
