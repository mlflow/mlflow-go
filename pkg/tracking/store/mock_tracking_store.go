...
func (_e *MockTrackingStore_Expecter) LogParam(ctx, runID, metric interface{}) *MockTrackingStore_LogParam_Call {
...
func (_m *MockTrackingStore) SetTraceTag(ctx context.Context, requestID, key, value string) error {
...
//   - key string
//   - value string
func (_e *MockTrackingStore_Expecter) SetTraceTag(ctx, requestID, key, value interface{}) *MockTrackingStore_SetTraceTag_Call {
	return &MockTrackingStore_SetTraceTag_Call{Call: _e.mock.On("SetTraceTag", ctx, requestID, key, value)}
}

func (_c *MockTrackingStore_SetTraceTag_Call) Run(run func(ctx context.Context, requestID, key, value string)) *MockTrackingStore_SetTraceTag_Call {
	_c.Call.Run(func(args mock.Arguments) {
