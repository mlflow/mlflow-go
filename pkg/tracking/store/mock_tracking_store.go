...
// LogParam provides a mock function with given fields: ctx, runID, param
func (_m *MockTrackingStore) LogParam(ctx context.Context, runID string, param *entities.Param) *contract.Error {
	ret := _m.Called(ctx, runID, param)
...
func (_e *MockTrackingStore_Expecter) LogParam(ctx interface{}, runID interface{}, param interface{}) *MockTrackingStore_LogParam_Call {
	return &MockTrackingStore_LogParam_Call{Call: _e.mock.On("LogParam", ctx, runID, param)}
}

func (_c *MockTrackingStore_LogParam_Call) Run(run func(ctx context.Context, runID string, param *entities.Param)) *MockTrackingStore_LogParam_Call {
	_c.Call.Run(func(args mock.Arguments) {
