...
func (s TrackingSQLStore) GetExperimentByID(id string) (*protos.Experiment, *contract.Error) {
...
func (s TrackingSQLStore) UpdateExperiment(experiment *protos.Experiment) *contract.Error {
